...
public class Main {
    ...
    static String st;
    static String pulpit = System.getProperty("user.home") + "/Desktop";
    public static void main(String[] args) throws IOException {
        System.out.println("Autor: Szymon Borzdyński");


        ArrayList<String> lista1 = Odczytaj_plik(pulpit + "\\pliki do JP\\Imiona1.txt");
        ArrayList<String> lista2 = Odczytaj_plik(pulpit + "\\pliki do JP\\Imiona2.txt");
        ArrayList<String> lista3 = Odczytaj_plik(pulpit + "\\pliki do JP\\Imiona3.txt");
